    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="sticky-top py-3 d-lg-block d-none">
          <h4 class="section-title">
            <font-awesome-icon icon="search" />條件搜尋
          </h4>
      ...
      <div class="col-lg-10">
        <div class="sticky-top p-3 d-block d-lg-none">
          <h4 class="section-title" data-toggle="collapse" data-target="#search">
            <font-awesome-icon icon="search" />條件搜尋
          </h4>
        ...
        <div class="product-list-wrapper" :class="{'is-loading':isLoading}">
          ...
          >
            <div
              class="col-sm-6 col-lg-4 mb-3 product-filter"
                ...
                <div class="product-content">
                  <div>
                    ...
                    <span v-else>
                      ...
                      <small>
                        <s class="text-muted">${{item.origin_price | moneyFilter}}</s>
                      </small>
                    </span>
                  </div>
                  <div>
